...
# If custom macro placement TCL is provided, source it
if { [env_var_exists_and_non_empty MACRO_PLACEMENT_TCL] } {
	log_cmd source $::env(MACRO_PLACEMENT_TCL)
} else {
	# If no macro strategy was provided, default to RTLMP
	if { ! [env_var_exists_and_non_empty MACRO_STRATEGY] } {
		set ::env(MACRO_STRATEGY) "HIER_RTLMP"
	}
